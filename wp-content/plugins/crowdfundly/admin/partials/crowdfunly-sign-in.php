                    ...
                    <form>
                      ...
                      <div class="auth-card__footer">
                        <div class="auth-card__forgot-password mb-3">
                          <a target="_blank" href="<?php echo esc_url( 'https://app.crowdfundly.com/dashboard/settings/app-key' ); ?>" class="auth-card__forgot-password-link"><?php echo __( 'Get APP Key', 'crowdfundly' ); ?></a>
                        </div>
                        ...
                        <?php 
                          printf(
                            ...
                            sprintf(
                              ...
                              esc_url( 'https://crowdfundly.com/terms/' ),
                              esc_html__( 'Terms', 'crowdfundly' )
                            ),
                            esc_html__( ' and ', 'crowdfundly' ),
                            sprintf(
                              '<a href="%s" target="_blank">%s</a>',
                              esc_url( 'https://crowdfundly.com/privacy/' ),
