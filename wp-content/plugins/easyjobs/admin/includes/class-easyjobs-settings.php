...
class EasyJobs_Settings {
    ...
    public static function save_basic_info()
    {
        ...
        echo Easyjobs_Helper::get_generic_response(Easyjobs_Api::post(
            'settings_basic_info',
            null,
            (array)json_decode(stripslashes($_POST['form_data']))
        ));
    ...
    public function get_company_info()
    {
        if($info = Easyjobs_Helper::get_company_info()){
            echo Easyjobs_Helper::get_success_response('Company info success', $info);
        }else{
            echo Easyjobs_Helper::get_error_response('Failed to get company info');
        }
        wp_die();
